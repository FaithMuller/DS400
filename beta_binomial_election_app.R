...
##
## Your answer: The more the numbers increases, the more thin the graphs gets. 
##
##
## ------------------------------------------------------------
...
##
## Your answer: Mode(π): this is what we get: no single mode when both α ≤ 1 and β ≤ 1 (density is bimodal, piling up at 0 and 1)
## This means 
##
## ------------------------------------------------------------
